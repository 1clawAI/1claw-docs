...
In the **dashboard** at [1claw.co](https://1claw.co), use **Vaults → [vault] → Policies → Create Policy**. You can select the target vault from a dropdown and, for agents, pick from your registered agents or enter a custom agent ID.
