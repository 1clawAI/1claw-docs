...
```bash
curl -X DELETE "https://api.1claw.co/v1/agents/00000000-0000-4000-8000-000000000000" \
...
```bash
curl -X POST "https://api.1claw.co/v1/agents/00000000-0000-4000-8000-000000000000/rotate-key" \
  -H "Authorization: Bearer <token>"
```
