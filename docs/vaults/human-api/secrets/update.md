...
Same request body as [Create a secret](/docs/vaults/human-api/secrets/create): `type`, `value`, and optional `metadata`, `expires_at`, `rotation_policy`, `max_access_count`.
