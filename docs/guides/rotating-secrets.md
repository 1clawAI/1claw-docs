...
1. **Client-supplied value** — **PUT** a new value to the same path. That creates a new version; previous versions remain in history (see [Create/update](/docs/human-api/secrets/create)).
