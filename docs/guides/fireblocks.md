...
- [Secret rotation](/docs/guides/secret-rotation-bindings) for rotating credentials without redeploying
- [Multi-chain signing](/docs/guides/multi-chain-signing) for provisioning keys on six chains
