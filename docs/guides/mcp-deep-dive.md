...
This guide goes beyond the [basic MCP setup](/docs/guides/mcp-integration) to cover configuration for specific tools, security best practices, and advanced usage patterns.

:::tip Already set up?
If you just need the quick config, see [MCP integration](/docs/guides/mcp-integration). This guide covers deeper integration patterns and per-client configuration.
:::
...
- [MCP integration](/docs/guides/mcp-integration) for the basic setup guide
- [MCP tools reference](/docs/mcp/tools) for detailed tool documentation
- [MCP security](/docs/mcp/security) for security model details
- [CLI guide](/docs/guides/cli) for `1claw setup` options
