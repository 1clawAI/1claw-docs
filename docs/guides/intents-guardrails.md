...
Part of the [Intents API](/docs/guides/intents-api) guide.
...
5. **Use testnets first** — use testnets to verify the flow before moving to mainnet. For EVM: Sepolia, Base Sepolia. For non-EVM: Bitcoin Signet, Solana Devnet, XRP Testnet, Cardano Preprod, Tron Shasta. See [Non-EVM networks](/docs/guides/intents-signing#non-evm-networks) for faucet links.
