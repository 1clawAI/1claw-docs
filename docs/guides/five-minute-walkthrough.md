...
The whole thing takes about five minutes assuming you already have an account. If you do not, [sign up at 1claw.xyz](https://1claw.xyz) first.
...
- Explore [multi-chain signing](/docs/guides/multi-chain-signing) for Bitcoin, Solana, XRP, Cardano, and Tron
