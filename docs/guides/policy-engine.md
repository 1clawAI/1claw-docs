...
- [Scoped permissions](/docs/guides/scoped-permissions) — built-in glob policies
- [Intents API guardrails](/docs/guides/intents-guardrails) — per-agent tx caps and allowlists
- [Webhooks](/docs/guides/webhooks) — `pending_approval.*` and circuit breaker events
