...
|----------|-------|-------|
| User login (email, social, passkey) | Privy Auth | Not the primary path. Available via [social login](/docs/guides/embedded-wallets-quickstart) for platform apps |
...
See the [Treasury guide](/docs/guides/treasury) for the full flow.
...
| Embedded wallet | Not needed (or: [embedded wallets](/docs/guides/embedded-wallets-quickstart)) | Privy handles user wallets |
...
- [Intents API](/docs/guides/intents-api) for full transaction signing docs
- [Multi-chain signing keys](/docs/guides/multi-chain-signing) for provisioning keys on Bitcoin, Solana, and more
- [Shroud](/docs/guides/shroud) for LLM traffic inspection and secret redaction
- [Human-in-the-loop approvals](/docs/guides/approvals) for agent transaction governance
