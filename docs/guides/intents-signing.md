...
| `xrpl_tx_json` | object | XRP | Full XRPL transaction JSON for [30+ transaction types](/docs/guides/intents-guardrails#xrpl-tx-types) (e.g. TrustSet, OfferCreate, NFTokenMint). Overrides `to`/`value`/`destination_tag` when present. |
