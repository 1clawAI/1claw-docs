...
- [Multi-chain signing](/docs/guides/multi-chain-signing) for non-EVM signing keys
- [Coinbase Smart Wallet](/docs/guides/coinbase-smart-wallet) for passkey-based smart accounts
