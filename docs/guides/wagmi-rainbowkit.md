...
- [Give an agent access](/docs/guides/give-agent-access) for vault, secret, and policy setup
- [Scaffold-Agent](/docs/guides/scaffold-agent) for a full monorepo template with 1claw + Scaffold-ETH
