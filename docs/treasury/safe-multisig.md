...
- [Treasury wallets](/docs/treasury/overview) for HSM-backed native wallets
- [Intents API](/docs/agents/intents/overview) for direct agent signing (non-multisig)
- [Account Abstraction](/docs/treasury/account-abstraction) for ERC-4337 smart accounts
- [Human-in-the-loop approvals](/docs/treasury/approvals) for the general approval framework
